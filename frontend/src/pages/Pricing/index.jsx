...
const Pricing = () => {
    ...
    const toggleClasses = isYearly
        ? 'bg-indigo-300 transform translate-x-full'
        : 'bg-teal-400';
    ...
    return (
        <section className="bg-base-200 overflow-hidden " id="pricing" style={{ background: "linear-gradient(-225deg, #69EACB 0%, #EACCF8 48%, #6654F1 100%)" }}>
            ...
            <div className="py-24 px-8 max-w-5xl mx-auto">
                <div className="flex flex-col text-center w-full mb-10 justify-center items-center">
                    ...
                    <div className="flex items-center mt-10">
                        <div
                            className="relative w-40 h-10 bg-gray-300 rounded-full p-1 cursor-pointer"
                            onClick={() => setIsYearly(!isYearly)}
                        >
                            <div className={`absolute inset-0 flex items-center justify-center w-1/2 h-full rounded-full shadow-md ${toggleClasses}`}>
                                {isYearly ? <span className="font-bold">Yearly</span> : <span className="font-bold">Monthly</span>}
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3 md:gap-4 justify-center">
                    {!isYearly ? (<>
                        ...
                        {config.stripe.yearlyplans.map((plan) => (
                                        ...
                                        {plan.showContactForm ? (
                                            ...
                                            <>
                                                ...
                                                <div className="flex flex-col justify-end mb-[4px]">
                                                    <p className="text-xs text-base-content/60 uppercase font-semibold">
                                                        USD
                                                        <span class="text-sm font-light sm:text-sm lowercase">/yr</span>
                                                    </p>
                                                </div>
                                            </>
                                        )}
