...
export function OnboardingLayout({ children }) {
  ...
  return (
    ...
    <div className="w-screen overflow-y-auto bg-slate-950  flex justify-center overflow-hidden">
      <div className="flex w-1/5 h-screen justify-center bg-[linear-gradient(to_right,#4f4f4f2e_1px,transparent_1px),linear-gradient(to_bottom,#4f4f4f2e_1px,transparent_1px)] bg-[size:14px_24px] items-center">
        {backBtn.showing && (
          <button
            disabled={backBtn.disabled}
            onClick={backBtn.onClick}
